...
aton_private_ranges = map(lambda r : (addr_aton(r[0]), addr_aton(r[1])) , private_ip_ranges)
aton_exp_ip_ranges = map(lambda r : (addr_aton(r[0]), addr_aton(r[1])) , exp_ip_ranges)
